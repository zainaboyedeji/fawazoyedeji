...
export const commissionsPage = [
    {
        ...
        src: gfh_one,
        description:
            <div><div><span>Gun for hire: Nigeria security fears spark boom in private protection - </span>Many guards for wealthy and middle-class people are hired police officers. In October 2021, I documented the private security landscape in Lagos for the <span>Financial Times. </span>The article sheds light on the prevalence of private security services in Nigeria, with an estimated 40% of the country's police officers working for these firms. The demand for such services has surged in response to the worsening security situation across the nation.</div> <div className="mt-4">Here is the link to the article: <a href="https://www.ft.com/content/a12bb6b1-798d-4863-8b49-104a56ccc716#comments-anchor" target="_blank" rel="noreferrer" title="Gun For Hire">Gun for hire.</a></div></div>,
        items: [
            {
                id: "1",
    ...
    },
    {
        ...
        src: hf_one,
        description:
            <div><div>Hidden Flows is an exhibition that aims to shed light on the often unseen dynamics of resources, infrastructure, and services in African cities. Through the lens of urban metabolism, we explore how resources flow within these cities, providing valuable insights for decision-makers and policy development. Unlike traditional research that relies on extensive quantitative data, we focus on the unique challenges faced in African contexts, where resources follow decentralized systems and involve informal networks.<div className="mt-5"> The images featured in the exhibition have been captured under the commission from ICLEI Local Government For Sustainability.</div><div className="mt-4">To experience the "Hidden Flows" exhibition and gain a deeper understanding of the intricate resource dynamics in African cities, visit the following link: <a href="https://www.thenatureofcities.com/hidden-flows-rise-africa/" target="_blank" rel="noreferrer" title="Hidden Flows">Hidden Flows Exhibition.</a></div></div></div>,
        items: [
            {
                id: "1",
...
export const projectsPage = [
    {
        ...
        src: yia_one,
        description:
          <div>  <div><span>'Yours In Arms'</span> highlights how surrounding circumstances have shaped the day-to-day struggles and resilience of students preserving the history of a civilian-run infantry in Nigeria. </div> <div>The establishment of paramilitary in institutions dates back to the Nigerian Second Republic[1976] under a militia regime headed by General Olusegun Obasanjo as a prospect to coax moreeducated fellows into the armed forces, soldiers would regularly come to inculcate military trainingin drills and parades, self-defense, physical fitness, first aid, citizenship, and leadership. Culturally,since its establishment, the program has been responsible for breeding a relative number ofcivilian youths dispersed throughout the nation, attached to a grass-rooted political scheme like this.</div><div>In modern times, the degree of pressure from being both CADET and STUDENT is considered anexhausting task.At Yaba College Of Technology alone, out of over 16,000 student enrolment,statistics show that approximately only 0.2% of this population usually makes the brave decisionand chose to combine this extracurricular activity with school work and personal life.</div><div>My project examines the diverse realities of life as a student cadet through a proper account oftheir in-group activities and the socio- political roles these youths play within the Nigerian context.I was inspired to start this story because I was once a member of this organization.After finishingmy service, It became clear how much I’ve been disconnected from their conventions over theyears, rather than embrace them.Mostly because I found it extremely hard to bear this militiajourney while managing other drastic social changes in my personal life.By reconnecting withthese cadets and photographing their realities both vigorous and vulnerable phases, I amexploring the truth and fiction of military personnel all over the world.</div> <div>'2018-Ongoing'"</div></div>,
        items: [
            {
                id: "1",
                src: yia_one,
    ...
    },
    {
        ...
        src: awakening_one,
        description:
            <div><div>After years of experiencing political corruption, human rights violation, and extortion within the SARS [Special Anti Robbery Squad] unit of the police force, young Nigerians are determined toreform the policing system through a series of peaceful nationwide protests until their demandsare met.</div><div className="mt-4">Despite a system that has been unresponsive to their need, the youth of Nigeria have spoken up.There is poetry to the fact that the protest erupted in October 2020; Oct. 1, 1960, marked theofficial date of Nigeria’s independence from British rule. Sixty years later, young Nigerians are stilldemanding freedom from repression.</div><div className="mt-4">The pattern of assembling policing forces to protect government over the people, to prey on localcommunities, and suppress dissent continued well into the 20th century. The Aba Women’s Warof 1929, the General Strike of 1945, and the Enugu Colliery Strike of 1949 were instances whereanti-colonial resistance was met with a quasi-military policing force deployed to subjugate citizens.</div><div className="mt-4">The #EndSARS protest which started as a peaceful demonstration by thousands of youthsquickly degenerated into chaos as security forces, mostly police began to use live ammunitionand tear gas on protesters leading to an estimated death of at least 100 individuals. 48 of whomwere killed on October 20, 2020, alone.</div><div className="mt-4">Here, I visualize my experience at four demonstrations I partook in at Lagos, Nigeria. Everything is
            captured in the spontaneous as we citizens mobilize collectively across the city. Each figure’s
            physical struggle is simultaneously expressive and reflective of the political situation.</div>  <div className="mt-4">"2020"</div> </div>,
        items: [
            {
                id: "1",
    ...
    },
    {
        ...
        src: mamp_one,
        description:
            <div><div> Every four years, when elections are approaching, thousands and thousands of party-political posters start to invade our cityscape. This has become almost a campaign weapon for parties" rivalries over urban space and for politicians to demonstrate their power and demarcate their territories. It is a visual performance of power.</div><div className="mt-4">In this work, I delve into the role of political posters in everyday party politicking in Nigeria, where they have become an almost normal or naturalized habitual repertoire of political action. </div><div className="mt-4">Printing in Nigeria is a growing industry that is becoming increasingly important to political culture. It is worth millions, despite still using artisanal methods in most places.  Posters, banners, and billboards are never big enough for politicians to impregnate our minds with their electoral ambition. Campaign after campaign, the posters are twice as large, twice as tall, and always more dominant than the previous one. </div><div className="mt-4">The candidates want to convince voters that they would be the best choice to run their life, through portraits that mimic historical and reassuring political leaders, either smiling or with emotionless faces. For the few months of the campaign, they are everywhere, on every corner, every street or bridge, and major road. We, as citizens, experience the hyper-visibility of politics before the images tarnish and the promises fade.</div></div>,
        items: [
            {
                id: "1",
    ...
    },
    {
        ...
        src: ot_one,
        description:
            <div><div>"Otto Daily" explores the complexities around how historical patterns like migration and religion, have reconfigured the identity of the indigenous Otto community in Lagos, Nigeria.</div><div  className="mt-4">Otto is located in the south of Oyingbo, Lagos. Prior to the sixteenth century a number of Awori,the southernmost of the Yoruba speaking people dispersed from Isheri, a village twelve miles upthe Ogun River, seeking refuge from conflict. A group of them settled in modern-day Lagos. Therethey established three main settlements, Iddo, Lagos Island, and Otto. Overtime, Iddo and LagosIsland both expanded into a major international metropolitan trading centers.</div><div className="mt-4">However, the Otto settlement still retains much of its and communal identity and domestic form of trade. This settlement has a tradition of origin that has been kept alive till today. Although mainly occupied by Yorubas, their customs and traditions have been redefined with distinct customsthrough the influx of people from neighboring states and the Nigerian hinterland.<div className="mt-4">"2018"</div></div></div>,
        items: [
            {
                id: "1",
    ...
    },
    {
        ...
        src: res_one,
        description:
            <div><div>It is common for Western charities to collect used clothes and ship them to Africa as aid. But these goods, discarded by well-intentioned Americans and Europeans, are rarely given as charity; instead, the donations are mostly sold to exporters who make huge profits selling second-hand goods in markets all over the continent. While some African countries have banned the importation of thrift clothes in a bid to protect local clothing and textile industries, in Nigeria the second-hand clothing industry – worth an estimated 148USD$ million – is booming.</div><div className="mt-5">Nigeria’s growing resale market can be traced back to the 1950s and 1960s. Then, Okrika, Rivers State, was the only port where used clothes from Europe could come through. Na mumu dey go boutique loosely translates to “only fools shop at boutiques.” These words are the chorus to a bustling market in Yaba, Lagos, Nigeria, sung by sellers of Okrika (second-hand clothing). Moreso, these words are a perception that much of the general populace holds regarding pre-owned pieces. Recent figures from the UN show that an estimated 80% of Africans wear secondhand clothing.</div><div className="mt-4">With the undeniable effects of fast fashion on global warming, it has become paramount to engage the masses about employing sustainable homegrown solutions to bypass the challenges of cloth production through a medium they can easily understand. It is my goal, not only to highlight the immense environmental complexities associated with the second-hand clothing industry but also the unique ecosystem involved with such a sector of the economy through the eyes of these traders.</div></div>,
        items: [
            {
                id: "1",
