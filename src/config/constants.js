...
export const commissionsPage = [
    {
        ...
        src: gfh_one,
        description:
            "Gun for hire: Nigeria security fears spark boom in private protection - Many guards for wealthy and middle-class people are hired police officers. In October 2021, I documented the private security landscape in Lagos for the Financial Times. The article sheds light on the prevalence of private security services in Nigeria, with an estimated 40% of the country's police officers working for these firms. The demand for such services has surged in response to the worsening security situation across the nation. Here is the link to the article: Gun for hire.",
        items: [
            {
                id: "1",
...
export const projectsPage = [
    ...
    },
    {
        ...
        src: awakening_one,
        description:
            "After years of experiencing political corruption, human rights violation, and extortion within the SARS [Special Anti Robbery Squad] unit of the police force, young Nigerians are determined toreform the policing system through a series of peaceful nationwide protests until their demandsare met.Despite a system that has been unresponsive to their need, the youth of Nigeria have spoken up.There is poetry to the fact that the protest erupted in October 2020; Oct. 1, 1960, marked theofficial date of Nigeria’s independence from British rule. Sixty years later, young Nigerians are stilldemanding freedom from repression.The pattern of assembling policing forces to protect government over the people, to prey on localcommunities, and suppress dissent continued well into the 20th century. The Aba Women’s Warof 1929, the General Strike of 1945, and the Enugu Colliery Strike of 1949 were instances whereanti-colonial resistance was met with a quasi-military policing force deployed to subjugate citizens.The #EndSARS protest which started as a peaceful demonstration by thousands of youthsquickly degenerated into chaos as security forces, mostly police began to use live ammunitionand tear gas on protesters leading to an estimated death of at least 100 individuals. 48 of whomwere killed on October 20, 2020, alone.Here, I visualize my experience at four demonstrations I partook in at Lagos, Nigeria. Everything is captured in the spontaneous as we citizens mobilize collectively across the city. Each figure’sphysical strugg",
        items: [
            {
                id: "1",
    ...
    },
    {
        ...
        src: mamp_one,
        description:
            'MO’ ADVERT MO’ POWER Every four years, when elections are approaching, thousands and thousands of party-political posters start to invade our cityscape. This has become almost a campaign weapon for parties" rivalries over urban space and for politicians to demonstrate their power and demarcate their territories. It is a visual performance of power.In this work, I delve into the role of political posters in everyday party politicking in Nigeria, where they have become an almost normal or naturalized habitual repertoire of political action. Printing in Nigeria is a growing industry that is becoming increasingly important to political culture. It is worth millions, despite still using artisanal methods in most places.  Posters, banners, and billboards are never big enough for politicians to impregnate our minds with their electoral ambition. Campaign after campaign, the posters are twice as large, twice as tall, and always more dominant than the previous one. The candidates want to convince voters that they would be the best choice to run their life, through portraits that mimic historical and reassuring political leaders, either smiling or with emotionless faces. For the few months of the campaign, they are everywhere, on every corner, every street or bridge, and major road… We, as citizens, experience the hyper-visibility of politics before the images tarnish and the promises fade.',
        items: [
            {
                id: "1",
    ...
    },
    {
        ...
        src: ot_one,
        description:
            '"Otto Daily" explores the complexities around how historical patterns like migration andreligion, have reconfigured the identity of the indigenous Otto community in Lagos, Nigeria.Otto is located in the south of Oyingbo, Lagos. Prior to the sixteenth century a number of Awori,the southernmost of the Yoruba speaking people dispersed from Isheri, a village twelve miles upthe Ogun River, seeking refuge from conflict. A group of them settled in modern-day Lagos. Therethey established three main settlements, Iddo, Lagos Island, and Otto. Overtime, Iddo and LagosIsland both expanded into a major international metropolitan trading centers.However, the Otto settlement still retains much of its and communal identity and domestic form oftrade. This settlement has a tradition of origin that has been kept alive till today. Although mainlyoccupied by Yorubas, their customs and traditions have been redefined with distinct customsthrough the influx of people from neighboring states and the Nigerian hinterland."2018"',
        items: [
            {
                id: "1",
